               ...
               <form action="<?php echo $action; ?>" method="post">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-group date">
                        ...
                        <input type="text" name="tgl_outbound" class="form-control pull-right" id="datepicker" value="<?php echo $tgl_outbound; ?>">
                     </div>
                     <!-- /.input group -->
                  </div>
                  <div class="form-group">
                     ...
                     <?php                                
                        foreach ($listbarang as $row) {
							if ($row->id_barang == $id_barang){
							  echo "<option selected disabled".$show." value='".$row->id_barang."'>".$row->nama_barang."</option>";
							}else{
