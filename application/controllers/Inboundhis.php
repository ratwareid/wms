...
class Inboundhis extends CI_Controller {
...
//            jika belum login redirect ke login
	...
	public function index(){
		$data['menu'] = 'inboundhis';
		$data['pagename'] = 'Laporan Barang Masuk';
		$data['action'] = 'inboundhis/cetakpdf';
		$data['heading'] = 'Cetak Laporan Barang Masuk';
		$data['content'] = 'inbound/content';
		$data['error'] = '';
		$data['datepicker2'] = '';
		$data['datepicker3'] = '';
		$data['listbarang'] = $this->inbound_model->getBarang();
		$this->load->view('inboundhis',$data);
    }
	...
	public function cetakpdf(){
        ...
        // mencetak string 
        $pdf->Cell(190,7,'Laporan Barang Masuk PT. Cakra Sanjaya Acs',0,1,'C');
         
        // Memberikan space kebawah agar tidak terlalu rapat
        $pdf->Cell(30,7,'',0,1);
        $pdf->SetFont('Arial','B',10);
        $pdf->Cell(60,6,'Tanggal Masuk',1,0);
        ...
        $rows = $this->inbound_model->getlist_print($datefrom,$dateto,$idbarang)->result();
        foreach ($rows as $row){
